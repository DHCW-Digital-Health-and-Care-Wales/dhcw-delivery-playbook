...
Before a team writes a single line of code, we need to understand what we're building and why. The Digital Service Standard for Wales sets out four phases that every DHCW product or service should move through. This playbook covers all four, though the emphasis shifts depending on where you are.
