...
**Open code.** Code written with public money should, wherever possible, be public. DHCW teams publish reusable code through the [NHS Wales Solution Exchange](https://github.com/GIGCymru/Solutions-Exchange) on GitHub. Before building something from scratch, teams should check whether a reusable component already exists. Before finishing a piece of work, teams should consider whether what they have built could be useful to another team or organisation. This is the Public Money, Public Code principle in practice. Use open standards for data and interoperability wherever they exist (for health data, that usually means HL7 FHIR), so what we build works with what others build.
...
[Point 9 of the Digital Service Standard for Wales, work in the open](https://digitalpublicservices.gov.wales/guidance-and-standards/digital-service-standard-wales/create-digital-teams#9.-work-in-the-open), asks teams to make the services they build, and the techniques used to build them, as open as possible, and to publish source code where it's safe to do so. DHCW teams are assessed against the standard and should be able to show how they meet it. The [service standard self-assessment](https://nhswales365.sharepoint.com/sites/DHC_UCD/SitePages/Service-standard-self-assessment.aspx) is how a team checks its position before a formal assessment (NHS Wales sign-in required). The Welsh Immunisation System, the first NHS Wales service to pass the standard, is the worked example.
